...
public class DiameterMessage implements ProtocolDefinitions {
   ...
   public void printContent(StringBuilder sb) {
      sb.append("Message Command Code: " + header.getCommandCode() + ", Application Id: " + header.getApplicationId() + ", HopByHop Id: "
            + header.getHopByHopId() + ", EndToEnd Id: " + header.getEndToEndId() + "\n");
      for (DiameterAVP avp : avpList) {
         sb.append("   ");
         avp.printContent(sb);
         sb.append("\n");
