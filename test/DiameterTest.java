...
public class DiameterTest implements ProtocolDefinitions {
   ...
   public static void main(String[] args) throws DiameterParseException, DiameterDictionaryException {
      ...
      // A)
      DiameterHeader header1 = new DiameterHeader(COMMAND_CER_CEA, APP_ID_DIAMETER_COMMON_MESSAGE);
      header1.setRequest(true);
      header1.setProxiable(true);
      DiameterMessage msg1 = new DiameterMessage(header1);

      // B)
      DiameterHeader header2 = new DiameterHeader(DIAMETER_VERSION, HEADER_FLAG_R_P, COMMAND_STR_STA, APP_ID_DIAMETER_COMMON_MESSAGE);
      DiameterMessage msg2 = new DiameterMessage(header2);

      // Method 2 - Use Message factory

      DiameterMessage msg3 = DiameterMessageFactory.createMessage(HEADER_FLAG_R_P, COMMAND_STR_STA, APP_ID_DIAMETER_COMMON_MESSAGE);
      ...
      avp2.setData("2"); // or you can set data as string and it will convert it to actual data format
      // according to AVP data type
      msg1.addAVP(avp2);
